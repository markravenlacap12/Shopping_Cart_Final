                    ...
                    <?php   if(isset($_GET['itemkey']) && isset($arrProducts[$_GET['itemkey']])):  ?>
                                ...
                                <div class="col-8">
                                    <div class="col-12">
                                        ...
                                        <input type="radio" name="radSize" id="radSeven" value="7" checked>
                                        <label for="radSeven">7</label> <br>
                                        <input type="radio" name="radSize" id="radEight" value="8">
                                        <label for="radEight">8</label> <br>
                                        <input type="radio" name="radSize" id="radNine" value="9">
                                        <label for="radNine">9</label> <br>
                                        <input type="radio" name="radSize" id="radTen" value="10">
                                        <label for="radTen">10</label> <br>
                                        <hr>
