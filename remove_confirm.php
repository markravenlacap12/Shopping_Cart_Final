...
<html lang="en">
    <head>
        ...
        <title>Remove Confirm | InvicShoes</title>
    </head>
    <body>
        <form method="post">
            <div class="container">
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="product-grid2 card">
                                <div class="product-image2 h-100">
                                    <a href="">
                                        <img class="pic-1 h-100" src="img/<?php echo $arrProducts[$_GET['delkey']]['photo1']; ?>">
                                        <img class="pic-2 h-100" src="img/<?php echo $arrProducts[$_GET['delkey']]['photo2']; ?>">
                                    </a>                            
                                </div>                        
                            </div>
                        </div>                
